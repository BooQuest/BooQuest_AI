...
# 예시: {"instagram": ["인스타툰 작가", "릴스 인스타"], ...}
all_platform_names = [
    {"category": category, "name": name}
    for category, names in PLATFORM_SIDE_JOBS["platforms"].items()
    for name in names
]
class PromptTemplates:
    ...
    def generate_recommendation_sidejob_prompt(user_profile: OnboardingProfile) -> str:
        ...
        {json.dumps(all_platform_names, ensure_ascii=False, indent=2)}
