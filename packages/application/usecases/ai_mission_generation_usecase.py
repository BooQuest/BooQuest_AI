...
from packages.application.ports.input.generate_mission_input_port import GenerateMissionInputPort
from packages.application.ports.output.generate_mission_output_port import GenerateMissionOutputPort
